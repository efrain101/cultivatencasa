...
@section('content')
    ...
    <div>
        <h1 id="tituloambientes" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir ambiente</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formuambientes" action="{{url("ambientes")}}" method="post" >
            @csrf
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        ...
                        <textarea name="especificacion"  placeholder="especificacion" style="WIDTH: 500px; HEIGHT: 150px; margin-top: 1em"></textarea>
