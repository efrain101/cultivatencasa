...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <a id="btnvolver" class="button" href="{{url("ambientes")}}" title="Regresar"> </a>
            </div>
        </div>
    </div>
    ...
    <div>
        <h1 id="tituloambientes" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar ambiente {{$ambiente->tipo}} </MARQUEE></h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="row" >
                    <div class="col-3" style="color: blue;font-family: 'Arial Black'">
                        ...
                        <div>
                            <label style="margin-top: 2em">Especificación</label>
                        </div>
                    </div>

                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="tipo" class="form-control" placeholder="tipo" value="{{$ambiente->tipo}}">
                        <textarea name="especificacion"  placeholder="especificacion" style="WIDTH: 500px; HEIGHT: 150px; margin-top: 1em">{{$ambiente->especificacion}}</textarea>
