...
@section('content')
    ...
    <div>
        <h1 id="titulocantidadescomplementos" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar cantidad "{{$cantidades_complemento->cantidad}}" </MARQUEE></h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="row" >
                    <div class="col-3" style="color: blue;font-family: 'Arial Black'">
                        <div>
                            <label style="margin-top: 2em">Cantidad</label>
                        </div>
                    </div>

                    <div class="col-4" style="font-family: 'Arial Black'">

                        <input type="range" min="1" max="1000" step="0.01" name="cantidad" style="margin-top: 2.5em" value="{{$cantidades_complemento->cantidad}}" oninput="this.nextElementSibling.value = this.value">
                        <output>{{$cantidades_complemento->cantidad}}</output>
