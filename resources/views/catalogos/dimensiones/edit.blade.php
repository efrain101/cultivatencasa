...
@section('content')
    ...
    <head>
        ...
        <title>Dimensiones de las mesas de cultivo</title>
        <!-- CSS only -->
    ...
    <div>
        <h1 id="titulodimension" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar dimensión</MARQUEE></h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="altura" class="form-control" placeholder="ingresa altura en cm" value="{{$dimensione->altura}}">
                        <input type="text"  name="ancho" class="form-control" placeholder="ingresa ancho en cm" style="margin-top: 2em" value="{{$dimensione->ancho}}">
                        <input type="text"  name="largo" class="form-control" placeholder="ingresa largo en cm" style="margin-top: 2em" value="{{$dimensione->largo}}">
