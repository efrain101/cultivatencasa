...
@section('content')
    ...
    <head>
        ...
        <title>Erradicación de enfermedades</title>
        <!-- CSS only -->
    ...
    <div>
        <h1 id="tituloerrapla" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar erradicación</MARQUEE></h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="erradicacion" class="form-control" placeholder="erradicacion" style="width: 800px; height: 80px" value="{{$erradicacion_plagas_c->erradicacion}}">
