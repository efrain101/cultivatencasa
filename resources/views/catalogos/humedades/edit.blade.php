...
@section('content')
    ...
    <div>
        <h1 id="titulohumedades" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar humedad</MARQUEE></h1>
    </div>

    <div class="container">
        <form action="{{url("humedades",$humedade->id_humedad)}}" method="POST">
            @csrf
            <div class="container">
                @method("PUT")
                <div class="row" >
