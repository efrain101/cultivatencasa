...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <a id="btnvolver" class="button" href="{{url("humedades")}}" title="Regresar"> </a>
            </div>
        </div>
    </div>
    ...
    <head>
        ...
        <title>Humedades de los cultivos</title>
    ...
    <div>
        <h1 id="titulohumedades" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir Humedades</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formuhumedades" action="{{url("humedades")}}" method="post" >
            @csrf
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        ...
                        <input type="range" min="1" max="1000" step="1" id="valor_minimo" name="valor_minimo" style="margin-top: 2em" {{--oninput="this.nextElementSibling.value = this.value"--}}>
                        <output id="salida"></output>

                        <br>

                        <input type="range" min="1" max="1000" step="1" id="valor_maximo" name="valor_maximo" style="margin-top: 2.5em" {{--oninput="this.nextElementSibling.value = this.value"--}}>
