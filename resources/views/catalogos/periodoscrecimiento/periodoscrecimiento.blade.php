...
@section('content')
    ...
    <div>
        <h1 id="tituloperiodoscrecimiento" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir Periodos de crecimiento</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formuperiodoscrecimiento" action="{{url("periodoscrecimiento")}}" method="post" >
            @csrf
            <div class="container">
                <div class="row" >
