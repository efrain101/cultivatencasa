...
@section('content')
    ...
    <div>
        <h1 id="tituloplagas" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir plaga</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formuplagas" action="{{url("plagas")}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        ...
                        <select name="id_tipo_plaga" class="form-control @error('id_tipo_plaga') is-invalid @enderror" name="id_tipo_plaga"  style="margin-top: 2em">
                            @foreach($tipos_plagas_c as $tipos_plagas_c)
                                <option value="{{$tipos_plagas_c['id_tipo_plaga']}}">{{$tipos_plagas_c['tipo']}}</option>
                            @endforeach
                        </select>
