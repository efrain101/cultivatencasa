...
@section('content')
    ...
    <head>
        ...
        <title>Prevención de enfermedades</title>
        <!-- CSS only -->
    ...
    <div>
        <h1 id="tituloprevenef" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar prevención</MARQUEE></h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="prevencion" class="form-control" placeholder="prevencion" style="width: 800px; height: 80px" value="{{$prevencion_enfermedades_c->prevencion}}">
