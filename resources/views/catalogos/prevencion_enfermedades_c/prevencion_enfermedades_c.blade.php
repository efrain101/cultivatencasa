...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <a id="btnvolver" class="button" href="{{url("prevencion_enfermedades_c")}}" title="Regresar"> </a>
            </div>
        </div>
    </div>
    ...
    <head>
        ...
        <title>Prevenciones de enfermedades</title>
    ...
    <div>
        <h1 id="tituloefectenf" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir prevención de enfermedades</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formuprevenf" action="{{url("prevencion_enfermedades_c")}}" method="post" >
            @csrf
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="prevencion" class="form-control" placeholder="prevencion" style="width: 800px; height: 80px">
