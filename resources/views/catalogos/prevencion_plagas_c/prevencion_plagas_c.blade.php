...
@section('content')
    ...
    <head>
        ...
        <title>Prevenciones de plagas</title>
    ...
    <div>
        <h1 id="titulopreenf" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir prevención de plagas</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formuprevpla" action="{{url("prevencion_plagas_c")}}" method="post" >
            @csrf
            <div class="container">
                <div class="row" >
