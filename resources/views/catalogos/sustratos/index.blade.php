...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2 style="color: #000000" align="center">Lista de Sustratos</h2>
            </div>
            @if(Auth::user()->tipo_usuario==1)
            <div class="pull-right">
                <a id="btnañadir" class="button" href="{{url("sustratos/create")}}" title="Registrar sustrato"> <i class="fas fa-plus-circle"></i>
                </a>
            </div>
            @endif
        </div>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <a class="button" href="{{url("sustratos",$sustrato->id_sustrato)."/edit"}}">
