            ...
            <div class="container">
                ...
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        ...
                        <input type="range" min="1" max="100" step="1" id="valor_minimo" name="valor_minimo" style="margin-top: 2em" value="{{$temperatura->valor_minimo}}" {{--oninput="this.nextElementSibling.value = this.value"--}}>
                        <output id="salida">{{$temperatura->valor_minimo}}</output>

                        <br>

                        <input type="range" min="1" max="100" step="1" id="valor_maximo" name="valor_maximo" style="margin-top: 2.5em" value="{{$temperatura->valor_maximo}}" {{--oninput="this.nextElementSibling.value = this.value"--}}>
                        <output id="salida2">{{$temperatura->valor_maximo}}</output>
