...
@section('content')
    ...
    <div>
        <h1 id="titulotemporadas" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar temporada</MARQUEE></h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="row" >
                    <div class="col-3" style="color: blue;font-family: 'Arial Black'">
                        ...
                        <div>
                            <label style="margin-top: 2em">Fecha de finalización</label>
                        </div>
                    </div>

                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="fecha_inicio" class="form-control" placeholder="fecha_inicio" value="{{$temporada->fecha_inicio}}">
                        <input type="text"  name="fecha_fin" class="form-control" placeholder="fecha_fin" style="margin-top: 1em " value="{{$temporada->fecha_fin}}">
