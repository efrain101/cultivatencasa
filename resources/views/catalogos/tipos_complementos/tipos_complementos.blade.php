...
@section('content')
    ...
    <div>
        <h1 id="titulotiposcomplementos" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir tipo de complemento</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formutipocomplementos" action="{{url("tipos_complementos")}}" method="post" >
            @csrf
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="nombre" class="form-control" placeholder="ingresa tipo" style="margin-top: 1em">
