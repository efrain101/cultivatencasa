...
@section('content')
    ...
    <div>
        <h1 id="titulotiposenfermedades" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar tipo de enfermedad "{{$tipos_enfermedades_c->tipo}}" </MARQUEE></h1>
    </div>

    <div class="container">
        <form action="{{url("tipoEnfermedadc",$tipos_enfermedades_c->id_tipo_enfermedad)}}" method="POST">
            @csrf
            <div class="container">
                @method("PUT")
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="tipo" class="form-control" placeholder="tipo" value="{{$tipos_enfermedades_c->tipo}}">
