    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="button" href="{{url("tipoEnfermedadc/create")}}" title="Registrar tipo de enfermedad"> <i class="fas fa-plus-circle"></i>
                </a>
            </div>
            @endif
        </div>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <a class="button" href="{{url("tipoEnfermedadc",$tipos_enfermedades_c->id_tipo_enfermedad)."/edit"}}">
