...
@section('content')
    ...
    <div>
        <h1 id="titulotiposplagas" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Editar tipo de plaga "{{$tipos_plagas_c->tipo}}" </MARQUEE></h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="row" >
                    ...
                    <div class="col-4" style="font-family: 'Arial Black'">
                        <input type="text"  name="tipo" class="form-control" placeholder="tipo" value="{{$tipos_plagas_c->tipo}}">
