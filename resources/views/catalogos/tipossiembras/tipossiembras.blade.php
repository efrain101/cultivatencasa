...
@section('content')
    ...
    <div>
        <h1 id="titulotipossiembras" style="text-align: center" ><MARQUEE BEHAVIOR="ALTERNATE">Añadir tipo de siembra</MARQUEE></h1>
    </div>


    <div class="container">
        <form id="formusustratos" action="{{url("tipossiembras")}}" method="post" >
            @csrf
            <div class="container">
                <div class="row" >
