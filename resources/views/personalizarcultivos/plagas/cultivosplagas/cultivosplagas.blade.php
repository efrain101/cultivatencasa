...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <a class="btn btn-primary" href="{{url("cultivosplagas")}}" style="font-size: large" title="Regresar"> <b><<</b></a>
            </div>
        </div>
    </div>
    ...
    <head>
        ...
        <title>Agregar plagas a cultivos</title>
    ...
    <div>
        <h1 id="tituloculpla" style="text-align: center" >Añadir plagas a los cultivos</h1>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Agregar plagas a los cultivos') }}</div>
    ...
    <div class="card-body">
        <form id="formuculpla" action="{{url("cultivosplagas")}}" method="post" >
            @csrf
